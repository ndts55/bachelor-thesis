...
\subsection{Acceptor}
$\Pa = \Mu{X} \ReceiveUnreliableP{s}{i}{j}{\LOneA}{\bot}{n'} .\\
\Indent{1}\If{n' = \bot}\\
\Indent{2}\Then{\SendUnreliableP{s}{j}{i}{\LOneB}{\bot}.\PaCont}\\
\Indent{2}\Else{\\
...
$\PaCont = \ReceiveWeaklyP{s}{i}{j}{\Accept . \ReceiveUnreliableP{s}{i}{j}{\LTwoA}{\bot}{pr'} .\\
\Indent{2}\If{pr' = \bot}\\
\Indent{3}\Then{\End}\\
\Indent{3}\Else{\\
...
\Or \Paren{
    \Mu{X} \ReceiveUnreliableP{s}{4}{2}{\LOneA}{\bot}{n'}.\If{\dots}
    \Or \Mu{X} \If{10 = \bot} \Then{\SendUnreliableP{s}{2}{4}{\LOneB}{\bot}.\PaCont} \Else{\dots}
} \comment{=\Acceptor{2}}\\
\Or \Paren{
    \Mu{X} \ReceiveUnreliableP{s}{4}{3}{\LOneA}{\bot}{n'}.\If{\dots}
    \Or \Mu{X} \If{10 = \bot} \Then{\SendUnreliableP{s}{3}{4}{\LOneB}{\bot}.\PaCont} \Else{\dots}
} \comment{=\Acceptor{3}}\\
\Or \InnerSessionQueues{s}
\Or \InnerSessionQueues{r}
\Or \OuterSessionQueues
...
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\bot}{n'}.\If{\dots}
%     \Or \Mu{X} \If{\bot = \bot} \Then{\PaCont} \Else{\dots}
% }\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{2}{\LOneA}{\bot}{n'}.\If{\dots}
%     \Or \Mu{X} \SendUnreliableP{r}{2}{4}{\LOneB}{\Promise{\Nothing}}.\PaCont
...
\Or \Mu{X} \If{5 = \bot} \Then{\PaCont} \Else{\dots} \comment{= \Acceptor{1}}\\
\Or \Mu{X} \If{5 = \bot} \Then{\PaCont} \Else{\dots} \comment{= \Acceptor{2}}\\
\Or \Mu{X} \If{\bot = \bot} \Then{\PaCont} \Else{\dots} \comment{= \Acceptor{3}}\\
\Or \InnerSessionQueues{s}
\Or \InnerSessionQueues{r}
\Or \OuterSessionQueues
\big )$
...
% \Or \Mu{X} \If{15 = \bot} \Then{\PaCont} \Else{\dots}\\
% \Or \Paren{
%     \Mu{X} \If{15 = \bot} \Then{\PaCont} \Else{\dots}
%     \Or \Mu{X} X
% }\\
% \Or \Mu{X} X\\
% \Or \InnerSessionQueues{s}
