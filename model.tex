...
$\Sys{\AcceptorCount}{\ProposerCount} = \SessionRequest{\OuterSharedPoint}{2}{t} . \PpInit{\AcceptorCount + 1}{\genAq{\AcceptorCount + \ProposerCount}{\AcceptorCount}{\ProposerCount}}{\AcceptorCount + \ProposerCount}{\AcceptorCount + \ProposerCount}{[]}\\
\Or \SessionAccept{\OuterSharedPoint}{1}{t} . \ParallelFor{\AcceptorCount < k < \AcceptorCount + \ProposerCount} \PpInit{\AcceptorCount + 1}{\genAq{k}{\AcceptorCount}{\ProposerCount}}{k}{k}{[]} \\
...
% \Nu{t}\big (
% \SessionRequest{\SharedPoint{4}}{4}{s}.\Pp{} \Or \SessionRequest{\SharedPoint{5}}{4}{r}.\Pp{} \\
% \Or \ParallelFor{3 < n \le 5} \SessionAccept{\SharedPoint{n}}{1}{s} . \Pa\\
% \Or \ParallelFor{3 < n \le 5} \SessionAccept{\SharedPoint{n}}{2}{s} . \Pa\\
% \Or \ParallelFor{3 < n \le 5} \SessionAccept{\SharedPoint{n}}{3}{s} . \Pa\\
% \Or \OuterSessionQueues
% \big )$
