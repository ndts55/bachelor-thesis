...
$\GlobalType = \Mu{X}
\Paren{\DotForall{a \in \AQ} \SendUnreliableG{p}{a}{\LOneA}{\mathbb{N}}} .
\Paren{\DotForall{a \in \AQ} \SendUnreliableG{a}{p}{\LOneB}{\Promise{\Value}}} .\\
\hspace*{0.5em}\SendWeaklyG{p}{\AQ}{\\
\hspace*{1em}
\Accept.\Paren{\DotForall{a \in \AQ} \SendUnreliableG{p}{a}{\LTwoA}{\Proposal{\Value}}}.end \oplus
\Restart.X \oplus
\Abort.end}$
...
\hspace*{0.5em}\left(\DotForall{j \in \AQ} \SendUnreliableP{s}{i}{j}{\LOneA}{\proposalNumber{n}{m}}\right) .\\
\hspace*{0.5em}\left(\DotForall{j \in \AQ} \ReceiveUnreliableP{s}{j}{i}{\LOneB}{\perp}{v_j}\right) .\\
...
$\mapstostar
\NuChannels\big (\\
\Mu{X} \update{n}{5} . \Paren{\DotForall{j\in \{1,2\}} \SendUnreliableP{s}{4}{j}{\LOneA}{\proposalNumber{n}{4}}}\dots \comment{= \Proposer{4}}\\
\Or \Mu{X} \update{n}{6} . \Paren{\DotForall{j\in \{2,3\}} \SendUnreliableP{r}{4}{j}{\LOneA}{\proposalNumber{n}{5}}}\dots \comment{= \Proposer{5}}\\
\Or \Paren{
...
% \NuChannels \big (
% \Mu{X} \SendUnreliableP{s}{4}{1}{\LOneA}{\proposalNumber{5}{4}}.\SendUnreliableP{s}{4}{2}{\LOneA}{\proposalNumber{5}{4}}\dots\\
% \Or \Mu{X} \SendUnreliableP{r}{4}{3}{\LOneA}{\proposalNumber{6}{5}}.\ReceiveUnreliableP{r}{2}{4}{\LOneB}{\perp}{v_2}\dots\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}
%     \Or \Mu{X} \ReceiveUnreliableP{r}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}
% }\\
...
% \NuChannels \big (
% \Mu{X} \SendUnreliableP{s}{4}{1}{\LOneA}{\proposalNumber{5}{4}}.\SendUnreliableP{s}{4}{2}{\LOneA}{\proposalNumber{5}{4}}\dots\\
% \Or \Mu{X} \ReceiveUnreliableP{r}{2}{4}{\LOneB}{\perp}{v_2}.\ReceiveUnreliableP{r}{3}{4}{\LOneB}{\perp}{v_3}\dots\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}
...
% \NuChannels \big (
% \Mu{X} \SendUnreliableP{s}{4}{1}{\LOneA}{\proposalNumber{5}{4}}.\SendUnreliableP{s}{4}{2}{\LOneA}{\proposalNumber{5}{4}}\dots\\
% \Or \Mu{X} \ReceiveUnreliableP{r}{3}{4}{\LOneB}{\perp}{v_3}.\If{\anyNack{\VectorV} \tOr \promiseCount{\VectorV} < 1} \Then{\dots}\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}
...
% \NuChannels \big (
% \Mu{X} \SendUnreliableP{s}{4}{1}{\LOneA}{\proposalNumber{5}{4}}.\SendUnreliableP{s}{4}{2}{\LOneA}{\proposalNumber{5}{4}}\dots\\
% \Or \Mu{X} \SendUnreliableP{r}{4}{2}{\LTwoA}{\ProposalC{\proposalNumber{5}{6}}{\promiseValue{\VectorV}}}.\\\hspace*{1em}\SendUnreliableP{r}{4}{3}{\LTwoA}{\ProposalC{\proposalNumber{5}{6}}{\promiseValue{\VectorV}}}\dots\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}
%     \Or \Mu{X} end
% }\\
...
% \Or \Mu{X} \ReceiveUnreliableP{s}{4}{1}{\LOneA}{\perp}{n'}.\If{\dots}\\
% \Or \Paren{
%     \Mu{X} \ReceiveUnreliableP{s}{4}{2}{\LOneA}{\perp}{n'}.\If{\dots}
...
% $=\\
% \NuChannels \big (
% \Mu{X} \ReceiveUnreliableP{s}{1}{4}{\LOneB}{\perp}{v_1}.\ReceiveUnreliableP{s}{2}{4}{\LOneB}{\perp}{v_2}\dots\\
% \Or \Mu{X} \If{\greaterThan{5}{\Nothing}} \Then{\update{n}{5}\dots}\Else{\dots}\\
% \Or \Paren{
%     \Mu{X} \If{\greaterThan{5}{\Just{10}}} \Then{\dots} \Else{\SendUnreliableP{s}{2}{4}{\LOneB}{\Nack{10}}.\PaCont}
%     \Or \Mu{X} X
% }\\
% \Or \Paren{
...
% $\mapstostar (USend + UGet, USend + UGet)\\
% \NuChannels \big (
% \Mu{X} \ReceiveUnreliableP{s}{1}{4}{\LOneB}{\perp}{v_1}.\ReceiveUnreliableP{s}{2}{4}{\LOneB}{\perp}{v_2}.\If{\dots}\\
