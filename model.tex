...
$\Proposer{5}$'s role is 3, because $|\AQ_5| + 1 = 2 + 1 = 3$.
...
&\Indent{3}\Else{\SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\Nack{\NumberRegister}}.\Call{\PaTwo}{\SessionChannel, \AcceptorRole, \ProposerRole, \NumberRegister, \ProposalRegister}}
\big ) \big )}
\\\\
