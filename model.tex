...
\Indent{1}\DotForall{j \in \AQ}{\ReceiveUnreliableP{s}{j}{i}{\LOneB}{\perp}{v_j}} .\\
\Indent{1}\If{\anyNack{\VectorV} \tOr \promiseCount{\VectorV} < \ceil{\frac{i}{2}}}\\
\Indent{2}\Then{\SendWeaklyP{s}{i}{\AQ}{\Restart}{X}}\\
\Indent{2}\Else{\\\Indent{3}\SendWeaklyP{s}{i}{\AQ}{\Accept}{\\\Indent{3}\DotForall{j \in \AQ}{\SendUnreliableP{s}{i}{j}{\LTwoA}{\ProposalC{\proposalNumber{n}{m}}{\promiseValue{\VectorV}}}}.\\\Indent{3}end}}$
...
\Indent{1}\If{n' = \perp}\\
\Indent{2}\Then{\PaCont}\\
\Indent{2}\Else{\\
\Indent{3}\If{\greaterThan{n'}{n}}\\
\Indent{3}\Then{\update{n}{n'}.\SendUnreliableP{s}{j}{i}{\LOneB}{\Promise{pr}}.\PaCont}\\
\Indent{3}\Else{\SendUnreliableP{s}{j}{i}{\LOneB}{\Nack{n}}.\PaCont}}$
...
Note that we also apply $\RUskip$ to $\Acceptor{1}$ and evaluate its branches.
