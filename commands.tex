...
\newcommand{\ProposerSessionRole}[0]{q}
...
\newcommand{\GlobalType}[0]{\operatorname{G_{\ProposerRole, \AQ}}}
...
\newcommand{\mSendWeaklyP}[4]{#1\left[#2, #3\right]!_w #4}
...
\newcommand{\PaThree}[1]{\Pa{3}\left(#1\right)}
...
\newcommand{\mIf}[0]{\IfName\;}
\newcommand{\ThenName}[0]{\mathtt{then}}
\newcommand{\mThen}[0]{\ThenName\;}
\newcommand{\ElseName}[0]{\mathtt{else}}
\newcommand{\mElse}[0]{\ElseName\;}
