...
% MPST
%% General
\newcommand{\DotForall}[2]{\left(\bigodot_{#1}\;#2\right)}
...
\newcommand{\GlobalType}[0]{\operatorname{G_{p, A_Q}}}
\newcommand{\SendUnreliableG}[4]{#1 \to_u #2 : #3 \left\langle #4 \right\rangle}
\newcommand{\SendWeaklyG}[3]{#1 \to_w #2 : #3}

%% Local Type
\newcommand{\LocalTypeProposer}[0]{T^p_{p, A_Q}}
\newcommand{\LocalTypeAcceptor}[0]{T^a_{p}}
...
\newcommand{\SendWeaklyL}[2]{\left[#1\right]!_w #2}
\newcommand{\ReceiveWeaklyL}[2]{\left[#1\right]?_w #2}
...
\newcommand{\PaAccept}[0]{\Pa_{acc}}
\newcommand{\PpInitName}[0]{\operatorname{P^p_{init}}}
\newcommand{\PpInit}[5]{\PpInitName\left(#1, #2, #3, #4, #5\right)}
\newcommand{\PpInitShort}[0]{\PpInitName\left(\dots\right)}
\newcommand{\PaInitName}[0]{\operatorname{P^a_{init}}}
...
% Functions
\newcommand{\proposalNumber}[2]{\operatorname{proposalNumber}_#2\left( #1\right)}
\newcommand{\promiseValue}[1]{\operatorname{promiseValue}\left(#1\right)}
...
\newcommand{\Rule}[1]{\Paren{\operatorname{#1}}}
...
\newcommand{\AcceptorProofCont}[0]{\AcceptorProof{c}}
...
\newcommand{\Tp}[0]{T^p}
\newcommand{\Ta}[0]{T^a}
\newcommand{\TpBranch}[0]{\Tp_{branch}}
\newcommand{\TpAccept}[0]{\Tp_{acc}}
\newcommand{\TaOneB}[0]{\Ta_{1b}}
\newcommand{\TaBranch}[0]{\Ta_{branch}}
\newcommand{\TaAccept}[0]{\Ta_{acc}}
