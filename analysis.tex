...
We observe that, $\Gamma\Vdash\GEnvEntry{p}{\mathbb{N}}$, $\Gamma\Vdash\GEnvEntry{k}{\mathbb{N}}$, $\Gamma\Vdash\GEnvEntry{n}{\mathbb{N}}$, $\Gamma\Vdash\GEnvEntry{m}{\mathbb{N}}$, and $\Gamma\Vdash\GEnvEntry{\AQ}{\List{\mathbb{N}}}$.
...
% TODO we define some global environments to make it less long (synonym for shorten/abbreviate).
