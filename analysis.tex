...
$\GlobalTypeProjection{\AcceptorRole}$ defines the local type for acceptors, assuming a proposer $\ProposerRole$.
...
\RightLabel{$\RPar$}
\BinaryInfC{$\Gamma\vdash \SessionAccept{\OuterSharedPoint}{1}{\OuterSessionChannel} \ldots \Or \ParallelFor{1 \leq \AcceptorRole \leq \AcceptorCount} \PaInitShort \vartriangleright \emptyset$}

\RightLabel{$\RPar$}
\BinaryInfC{$\Gamma\vdash \SessionRequest{\OuterSharedPoint}{2}{\OuterSessionChannel}.\PpInitShort \Or \SessionAccept{\OuterSharedPoint}{1}{\OuterSessionChannel} \ldots \Or \ParallelFor{1 \leq \AcceptorRole \leq \AcceptorCount} \PaInitShort \vartriangleright \emptyset$}
\end{prooftree}
...
\noLine
\UnaryInfC{$\Gamma\vdash \PaOne \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\GlobalTypeProjection{\AcceptorRole}}$}
\RightLabel{$\RAcc$}
\UnaryInfC{$\Gamma\vdash\SessionAccept{\SharedPoint{k}}{\AcceptorRole}{s}.\PaOne\vartriangleright\emptyset$}
\AxiomC{$\ldots$}
...
\noLine
\UnaryInfC{$\GammaXV \vdash \SendWeaklyP{s}{\ProposerRole}{\AQ}{\Restart}{\RecursionVariable} \vartriangleright \SEnvEntry{s}{\ProposerRole}{\TpBranch}$}

\AxiomC{$\ProposerProofFalse$}
\noLine
\UnaryInfC{$\GammaXV \vdash \SendWeaklyP{s}{\ProposerRole}{\AQ}{\Accept}{\ldots} \vartriangleright \SEnvEntry{s}{\ProposerRole}{\TpBranch}$}

\RightLabel{$\RIf$}
\BinaryInfC{$\GammaXV \vdash \If{e} \Then{\SendWeaklyP{s}{\ProposerRole}{\AQ}{\Restart}{\RecursionVariable}} \Else{\SendWeaklyP{s}{\ProposerRole}{\AQ}{\Accept}{\ldots}} \vartriangleright \SEnvEntry{s}{\ProposerRole}{\TpBranch}$}

\RightLabel{$\RUget^{|\AQ|}$}
\UnaryInfC{$\GammaX \vdash \DotForall{\AcceptorRole\in\AQ}{\ReceiveUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\bot}{v_{\AcceptorRole}}} \ldots \vartriangleright \SEnvEntry{s}{\ProposerRole}{\DotForall{\AcceptorRole\in\AQ}{\ReceiveUnreliableL{\AcceptorRole}{\LOneB}{\Promise{\Value}}}}$}

\RightLabel{$\RUsend^{|\AQ|}$}
\UnaryInfC{$\GammaX \vdash \DotForall{\AcceptorRole\in\AQ}{\SendUnreliableP{s}{\ProposerRole}{\AcceptorRole}{\LOneA}{pn}} \ldots \vartriangleright \SEnvEntry{s}{\ProposerRole}{\DotForall{\AcceptorRole\in\AQ}{\SendUnreliableL{\AcceptorRole}{\LOneA}{\mathbb{N}}}\ldots}$}

\RightLabel{$\RSideEffect$}
\UnaryInfC{$\GammaX \vdash \update{\NumberRegister}{\NumberRegister + 1} \ldots \vartriangleright \SEnvEntry{s}{\ProposerRole}{\DotForall{\AcceptorRole\in\AQ}{\SendUnreliableL{\AcceptorRole}{\LOneA}{\mathbb{N}}}\ldots}$}

\RightLabel{$\RRec$}
\UnaryInfC{$\Gamma\vdash \Mu{\RecursionVariable} \update{\NumberRegister}{\NumberRegister + 1} \ldots \vartriangleright \SEnvEntry{s}{\ProposerRole}{\Mu{\RecursionVariableType}\DotForall{\AcceptorRole\in\AQ}{\SendUnreliableL{\AcceptorRole}{\LOneA}{\mathbb{N}}}\ldots}$}

\LeftLabel{$\ProposerProof{} =$}
\RightLabel{$\RReq$}
\UnaryInfC{$\Gamma\vdash \SessionRequest{\SharedPoint{MMM}}{\ProposerRole}{s}.\Pp{} \vartriangleright \emptyset$}
\end{prooftree}
...
\AxiomC{}
\RightLabel{$\RVar$}
\UnaryInfC{$\GammaXV\vdash \RecursionVariable \vartriangleright \SEnvEntry{s}{\ProposerRole}{\RecursionVariableType}$}
\LeftLabel{$\ProposerProofTrue =$}
\RightLabel{$\RWsel$}
\UnaryInfC{$\GammaXV\vdash \SendWeaklyP{s}{\ProposerRole}{\AQ}{\Restart}{\RecursionVariable} \vartriangleright \SEnvEntry{s}{\ProposerRole}{\SendWeaklyL{\AQ}{\Accept . \TpAccept \oplus \Restart . \RecursionVariableType \oplus \Abort .\End}}$}
\end{prooftree}
...
\AxiomC{}
\RightLabel{$\REnd$}
\UnaryInfC{$\GammaXV\vdash \End \vartriangleright \SEnvEntry{s}{\ProposerRole}{\End}$}
\RightLabel{$\RUsend^{|\AQ|}$}
\UnaryInfC{$\GammaXV\vdash \DotForall{\AcceptorRole\in\AQ}{\SendUnreliableP{s}{\ProposerRole}{\AcceptorRole}{\LTwoA}{prop}}.\End \vartriangleright \SEnvEntry{s}{\ProposerRole}{\DotForall{\AcceptorRole\in\AQ}{\SendUnreliableL{\AcceptorRole}{\LTwoA}{\Proposal{\Value}}}.\End}$}

\LeftLabel{$\ProposerProofFalse =$}
\RightLabel{$\RWsel$}
\UnaryInfC{$\GammaXV\vdash \SendWeaklyP{s}{\ProposerRole}{\AQ}{\Accept.\ldots} \vartriangleright \SEnvEntry{s}{\ProposerRole}{\SendWeaklyL{\AQ}{\Accept . \TpAccept \oplus \Restart . \RecursionVariableType \oplus \Abort .\End}}$}
\end{prooftree}
...
\\\\
&\Pa{f} = \SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\Nack{\NumberRegister}}.\PaTwo
\\\\
...
\noLine
\UnaryInfC{$\GammaXN\vdash \PaTwo \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaBranch}$}
\RightLabel{$\RUsend$}
\UnaryInfC{$\GammaXN\vdash \SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\bot}.\PaTwo \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}

\AxiomC{$\AcceptorProof{gt}$}
\noLine
\UnaryInfC{$\GammaXN\vdash \Pa{gt} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}

\RightLabel{$\RIf$}
\BinaryInfC{$\GammaXN\vdash \If{n'=\bot}\Then{\SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\bot}.\PaTwo}\Else{\If{\greaterThan{n'}{\NumberRegister}}\ldots} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}

\RightLabel{$\RUget$}
\UnaryInfC{$\GammaX \vdash \ReceiveUnreliableP{s}{\ProposerRole}{\AcceptorRole}{\LOneA}{\bot}{n'}.\If{n'=\bot}\ldots \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\ReceiveUnreliableL{\ProposerRole}{\LOneA}{\mathbb{N}}.\TaOneB}$}

\LeftLabel{$\AcceptorProofOne =$}
\RightLabel{$\RRec$}
\UnaryInfC{$\Gamma\vdash \Mu{\RecursionVariable} \ReceiveUnreliableP{s}{\ProposerRole}{\AcceptorRole}{\LOneA}{\bot}{n'}.\ldots \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\Mu{\RecursionVariableType}\ReceiveUnreliableL{\ProposerRole}{\LOneA}{\mathbb{N}}.\ldots}$}
\end{prooftree}
...
\noLine
\UnaryInfC{$\GammaXN\vdash \Pa{t} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}

\AxiomC{$\AcceptorProofFalse$}
\noLine
\UnaryInfC{$\GammaXN\vdash \Pa{f} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}

\LeftLabel{$\AcceptorProof{gt} =$}
\RightLabel{$\RIf$}
\BinaryInfC{$\GammaXN\vdash \If{\greaterThan{n'}{\NumberRegister}}\Then{\Pa{t}}\Else{\Pa{f}} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaOneB}$}
\end{prooftree}
...
\RightLabel{$\RUsend$}
\UnaryInfC{$\GammaXN\vdash \SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\Nack{\NumberRegister}}.\PaTwo \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\SendUnreliableL{\ProposerRole}{\LOneB}{\Promise{\Value}} . \TaBranch}$}
\end{prooftree}
...
\noLine
\UnaryInfC{$\GammaXN\vdash \PaAccept \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaAccept}$}

\AxiomC{}
\RightLabel{$\RVar$}
\UnaryInfC{$\GammaXN\vdash \RecursionVariable \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\RecursionVariableType}$}

\AxiomC{}
\RightLabel{$\REnd$}
\UnaryInfC{$\GammaXN\vdash \End \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}

\LeftLabel{$\AcceptorProofTwo =$}
\RightLabel{$\RWbran$}
\TrinaryInfC{$\GammaXN\vdash \PaTwo \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\TaBranch}$}
\end{prooftree}
...
\AxiomC{}
\RightLabel{$\REnd$}
\UnaryInfC{$\GammaXNP\vdash \End \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}

\AxiomC{$\AcceptorProof{update}$}
\noLine
\UnaryInfC{$\GammaXNP\vdash\update{\ProposalRegister}{pr'}.\ldots \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}
...
\RightLabel{$\RIf$}
\BinaryInfC{$\GammaXNP\vdash \If{\greaterEqual{\nFromProposal{pr'}}{\NumberRegister}}\Then{\ldots}\Else{\End} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}

\RightLabel{$\RIf$}
\BinaryInfC{$\GammaXNP\vdash \If{pr'=\bot}\Then{\End}\Else{\ldots} \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}
\LeftLabel{$\AcceptorProofAccept =$}
\RightLabel{$\RUget$}
\UnaryInfC{$\GammaXN\vdash \ReceiveUnreliableP{s}{\ProposerRole}{\AcceptorRole}{\LTwoA}{\bot}{pr'}.\ldots \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\ReceiveUnreliableL{\ProposerRole}{\LTwoA}{\Proposal{\Value}}.\End}$}
\end{prooftree}
...
\UnaryInfC{$\GammaXNP\vdash \End \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}
\RightLabel{$\RSideEffect$}
\UnaryInfC{$\GammaXNP\vdash \update{\NumberRegister}{\Just{\nFromProposal{pr'}}}.\End \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\End}$}
