...
\RightLabel{$\RUsend$}
\UnaryInfC{$\GammaXN\vdash \SendUnreliableP{s}{\AcceptorRole}{\ProposerRole}{\LOneB}{\Nack}.\PaTwo \vartriangleright \SEnvEntry{s}{\AcceptorRole}{\SendUnreliableL{\ProposerRole}{\LOneB}{\Promise{\Value}} . \TaBranch}$}
\end{prooftree}
