...
% def: all non-failing participants eventually decide
The implementation satisfies termination.

\subsection{Agreement}
% def: all decision values are the same
The implementation satisfies agreement.

\subsection{Validity}
% def: each decision value is an initial (or rather proposed) value of a participant
